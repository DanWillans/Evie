...
TEST_CASE("Test system manager")
{
  ...
  struct System4 : public evie::System
  {
  };
  struct System5 : public evie::System
  {
  };
  ...
  // Create components
  evie::ComponentManager comp_man;
  ...
  // Create systems
  evie::SystemManager sys_man(&comp_man);
