...
{
  glUniform1i(glad_glGetUniformLocation(id_, name.c_str()), static_cast<int>(value));
}
...
{
  glUniformMatrix4fv(glad_glGetUniformLocation(id_, name.c_str()), 1, GL_FALSE, first_element);
}
