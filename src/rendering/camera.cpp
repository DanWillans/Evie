...
{
  if (lock_z_) {
    position_ -= glm::normalize(glm::cross(vec3{ direction_.x, 0.0, direction_.z }, up_)) * camera_speed
                 * delta_time;// NOLINT(*-union-access)
  } else {
