...
// configuration step. It creates a namespace called `Evie`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Evie::cmake::project_name, Evie::cmake::project_version) };
